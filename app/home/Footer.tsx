...
export default function Footer() {
  return (
    <footer className="relative -z-10 mt-[-800px] flex h-[1380px] w-full items-end justify-center bg-[#25293A] bg-[url('../public/assets/home/bg-pattern-footer.svg')] bg-[length:1530px] bg-[50%_-14%] bg-no-repeat px-10 md:mt-[-550px] md:h-[1086px] screenInBetween:mt-[-254px] screenInBetween:h-[603px] screenInBetween:bg-[length:2036px] screenInBetween:bg-[calc(50%-400px)_43%] screen1200:px-0">
